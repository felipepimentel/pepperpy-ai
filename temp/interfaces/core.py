"""Core protocols and interfaces for PepperPy.

This module provides the core protocols and interfaces for the PepperPy framework,
defining the contracts that components must adhere to.
"""
