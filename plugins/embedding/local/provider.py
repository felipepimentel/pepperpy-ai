...
This provider implements local functionality for the PepperPy embedding framework.
"""
...
class LocalProvider(class LocalProvider(EmbeddingProvider, ProviderPlugin):
    """
Embedding local provider
