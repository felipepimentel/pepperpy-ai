"""
Embedding huggingface provider

This provider implements huggingface functionality for the PepperPy embedding framework.
"""
...
class HuggingfaceProvider(class HuggingfaceProvider(EmbeddingProvider, ProviderPlugin):
    """
Embedding huggingface provider

This provider enables huggingface functionality.
"""):
    """
    Embedding huggingface provider.
