"""
Embedding cohere provider

This provider implements cohere functionality for the PepperPy embedding framework.
"""
...
class CohereProvider(class CohereProvider(EmbeddingProvider, ProviderPlugin):
    """
Embedding cohere provider

This provider enables cohere functionality.
"""):
    """
    Embedding cohere provider.
