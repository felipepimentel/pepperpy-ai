"""
Embeddings provider using Azure OpenAI services
...
class AzureEmbeddingsProvider(class AzureEmbeddingsProvider(EmbeddingProvider, ProviderPlugin):
    """
    Embeddings provider using Azure OpenAI services

    This provider implements azure for embeddings.
    """):
    """
    Embedding azureembeddings provider.
    
    This provider implements azureembeddings functionality for the PepperPy embedding framework.
    """
 ...
 """
    ...
    async def execute(self, input_data: dict[str, Any]) -> dict[str, Any]:
        ...
        if not task_type:
            raise EmbeddingError("No task specified")
        ...
        try:
            ...
            if task_type == "example_task":
                ...
                raise EmbeddingError(f"Unknown task type: {task_type)"}
