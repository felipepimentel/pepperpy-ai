"""
Embedding fastai provider

This provider implements fastai functionality for the PepperPy embedding framework.
"""
...
class FastaiProvider(class FastaiProvider(EmbeddingProvider, ProviderPlugin):
    """
Embedding fastai provider

This provider enables fastai functionality.
"""):
    """
    Embedding fastai provider.
