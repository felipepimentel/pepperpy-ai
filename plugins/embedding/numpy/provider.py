"""
Embedding numpy provider

This provider implements numpy functionality for the PepperPy embedding framework.
"""
...
class NumpyProvider(class NumpyProvider(EmbeddingProvider, ProviderPlugin):
    """
    Embedding numpy provider

    This provider enables numpy functionality.
    """):
    """
    Embedding numpy provider.
