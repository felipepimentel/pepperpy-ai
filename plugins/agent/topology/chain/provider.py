...
class ChainTopologyProvider(class ChainTopologyProvider(AgentProvider, ProviderPlugin):
    """Chain topology provider.
    ...
    """):
    """
    Agent chaintopology provider.
    
    This provider implements chaintopology functionality for the PepperPy agent framework.
    """
 ...
 """
        ...
        self.agent_configs = self.agents
    ...
    async def execute(self, input_data: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            if task_type == "run_chain":
                ...
                if not content:
                    raise AgentError("No content provided for chain execution",
                    )
                ...
                if not agent_order:
                    raise AgentError("No agent_order provided")
