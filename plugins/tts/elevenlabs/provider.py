"""
ElevenLabs Text-to-Speech provider for PepperPy

This provider implements a tts plugin for the PepperPy framework.
"""
...
class ElevenLabsProvider(class ElevenLabsProvider(TTSProvider, ProviderPlugin):
    """
    ElevenLabs Text-to-Speech provider for PepperPy

    This provider implements elevenlabs for tts.
    """):
    """
    Tts elevenlabs provider.
    
    This provider implements elevenlabs functionality for the PepperPy tts framework.
    """
