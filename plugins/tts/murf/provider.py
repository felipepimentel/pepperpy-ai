"""
Provider for Murf for tts tasks
...
class MurfTTSProvider(class MurfTTSProvider(TTSProvider, ProviderPlugin):
    """
    Provider for Murf for tts tasks

    This provider implements murf for tts.
    """):
    """
    Tts murftts provider.
    
    This provider implements murftts functionality for the PepperPy tts framework.
    """
