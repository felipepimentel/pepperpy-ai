"""
Azure Text-to-Speech provider for PepperPy
...
class AzureProvider(class AzureProvider(TTSProvider, ProviderPlugin):
    """
    Azure Text-to-Speech provider for PepperPy

    This provider implements azure for tts.
    """):
    """
    Tts azure provider.
    
    This provider implements azure functionality for the PepperPy tts framework.
    """
