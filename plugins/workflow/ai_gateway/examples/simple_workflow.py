...
async def chat_example() -> None:
    ...
    async with BaseWorkflow(llm_provider="basic") as workflow:
...
async def rag_example() -> None:
    ...
    async with BaseWorkflow(llm_provider="basic", use_rag=True) as workflow:
...
async def vision_example() -> None:
    ...
    async with BaseWorkflow(llm_provider="basic", use_vision=True) as workflow:
...
async def tool_example() -> None:
    ...
    async with BaseWorkflow(
        llm_provider="basic", tools=["calculator", "weather"]
    ) as workflow:
        # Use calculator tool
