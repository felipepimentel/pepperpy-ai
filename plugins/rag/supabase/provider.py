"""
Rag supabase provider

This provider implements supabase functionality for the PepperPy rag framework.
"""
...
class SupabaseProvider(class SupabaseProvider(RAGProvider, ProviderPlugin):
    """
Rag supabase provider
