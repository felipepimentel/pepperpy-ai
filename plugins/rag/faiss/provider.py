...
This provider implements faiss functionality for the PepperPy rag framework.
"""
...
class FaissProvider(class FaissProvider(RAGProvider, ProviderPlugin):
    """
Rag faiss provider

This provider enables faiss functionality.
"""):
    """
    Rag faiss provider.
