"""
Rag lancedb provider

This provider implements lancedb functionality for the PepperPy rag framework.
"""
...
class LancedbProvider(class LancedbProvider(RAGProvider, ProviderPlugin):
    """
Rag lancedb provider

This provider enables lancedb functionality.
"""):
    """
    Rag lancedb provider.
