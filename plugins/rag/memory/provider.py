...
This provider implements memory functionality for the PepperPy rag framework.
"""
...
class MemoryProvider(class MemoryProvider(RAGProvider, ProviderPlugin):
    """
Rag memory provider

This provider enables memory functionality.
"""):
    """
    Rag memory provider.
