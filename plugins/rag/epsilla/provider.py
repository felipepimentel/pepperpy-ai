"""
Rag epsilla provider

This provider implements epsilla functionality for the PepperPy rag framework.
"""
...
class EpsillaProvider(class EpsillaProvider(RAGProvider, ProviderPlugin):
    """
Rag epsilla provider

This provider enables epsilla functionality.
"""):
    """
    Rag epsilla provider.
