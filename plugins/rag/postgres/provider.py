"""
Rag postgres provider

This provider implements postgres functionality for the PepperPy rag framework.
"""
...
class PostgresProvider(class PostgresProvider(RAGProvider, ProviderPlugin):
    """
Rag postgres provider

This provider enables postgres functionality.
"""):
    """
    Rag postgres provider.
