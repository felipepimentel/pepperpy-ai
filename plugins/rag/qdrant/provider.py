...
This provider implements qdrant functionality for the PepperPy rag framework.
"""
...
class QdrantProvider(class QdrantProvider(RAGProvider, ProviderPlugin):
    """
Rag qdrant provider

This provider enables qdrant functionality.
"""):
    """
    Rag qdrant provider.
