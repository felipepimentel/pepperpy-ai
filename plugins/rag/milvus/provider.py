...
This provider implements milvus functionality for the PepperPy rag framework.
"""
...
class MilvusProvider(class MilvusProvider(RAGProvider, ProviderPlugin):
    """
Rag milvus provider

This provider enables milvus functionality.
"""):
    """
    Rag milvus provider.
