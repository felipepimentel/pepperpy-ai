...
This provider implements vqlite functionality for the PepperPy rag framework.
"""
...
class VqliteProvider(class VqliteProvider(RAGProvider, ProviderPlugin):
    """
Rag vqlite provider

This provider enables vqlite functionality.
"""):
    """
    Rag vqlite provider.
