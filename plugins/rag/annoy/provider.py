...
This provider implements annoy functionality for the PepperPy rag framework.
"""
...
class AnnoyProvider(class AnnoyProvider(RAGProvider, ProviderPlugin):
    """
Rag annoy provider

This provider enables annoy functionality.
"""):
    """
    Rag annoy provider.
