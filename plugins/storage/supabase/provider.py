"""
Storage supabase provider

This provider implements supabase functionality for the PepperPy storage framework.
"""
...
class SupabaseProvider(class SupabaseProvider(StorageProvider, ProviderPlugin):
    """
Storage supabase provider

This provider enables supabase functionality.
"""):
    """
    Storage supabase provider.
