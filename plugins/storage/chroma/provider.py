"""
Storage chroma provider

This provider implements chroma functionality for the PepperPy storage framework.
"""
...
class ChromaProvider(class ChromaProvider(StorageProvider, ProviderPlugin):
    """
Storage chroma provider

This provider enables chroma functionality.
"""):
    """
    Storage chroma provider.
