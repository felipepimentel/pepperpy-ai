...
This provider implements db functionality for the PepperPy storage framework.
"""
...
class DbProvider(class DbProvider(StorageProvider, ProviderPlugin):
    """
Storage db provider

This provider enables db functionality.
"""):
    """
    Storage db provider.
