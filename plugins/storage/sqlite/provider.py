...
This provider implements sqlite functionality for the PepperPy storage framework.
"""
...
class SqliteProvider(class SqliteProvider(StorageProvider, ProviderPlugin):
    """
Storage sqlite provider

This provider enables sqlite functionality.
"""):
    """
    Storage sqlite provider.
