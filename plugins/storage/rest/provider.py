"""
Storage rest provider

This provider implements rest functionality for the PepperPy storage framework.
"""
...
class RestProvider(class RestProvider(StorageProvider, ProviderPlugin):
    """
Storage rest provider

This provider enables rest functionality.
"""):
    """
    Storage rest provider.
