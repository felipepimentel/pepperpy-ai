...
class ComponentPool:
    ...
    def register(self, component: LifecycleComponent) -> None:
        ...
        self._metrics.record_metric(
            "component_registered", 1, {"component": component.name}
        )
    ...
    def unregister(self, component_name: str) -> None:
        ...
        self._metrics.record_metric(
            "component_unregistered", 1, {"component": component_name}
        )
    ...
    async def initialize_all(self) -> None:
        ...
        try:
            ...
            self._metrics.record_metric("components_initialized", len(components))
    ...
    async def start_all(self) -> None:
        ...
        try:
            ...
            self._metrics.record_metric("components_started", len(components))
        except Exception as e:
    ...
    async def stop_all(self) -> None:
        ...
        try:
            ...
            self._metrics.record_metric("components_stopped", len(components))
        except Exception as e:
    ...
    async def finalize_all(self) -> None:
        ...
        try:
            ...
            self._metrics.record_metric("components_finalized", len(components))
        except Exception as e:
