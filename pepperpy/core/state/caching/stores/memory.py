...
from pepperpy.caching.errors import CacheKeyError
...
class MemoryStore(CacheStore[CacheValueType], Generic[CacheValueType]):
    ...
    async def get_metadata(self, key: CacheKey) -> CacheMetadata | None:
    ...
    async def get_keys(self) -> builtins.set[CacheKey]:
    ...
    async def get_capacity(self) -> int | None:
