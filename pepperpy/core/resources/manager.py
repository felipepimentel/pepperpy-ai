...
class ResourceManager(Lifecycle):
    ...
    def __init__(self, config: Optional[ResourceManagerConfig] = None) -> None:
        ...
        # Metrics
        self._total_resources: Optional[Gauge] = None
        self._allocated_resources: Optional[Gauge] = None
        self._in_use_resources: Optional[Gauge] = None
        self._allocation_errors: Optional[Counter] = None
    ...
    async def allocate(
        self, resource_type: str, name: Optional[str] = None, **kwargs: Any
    ) -> Resource:
        """Allocate resource.
