"""Core functionality for data persistence and storage.

This module provides the core functionality for data persistence and storage,
...
class ConnectionError(StorageError):
    """Error raised when there is a connection error."""
...
class StorageProvider(ABC):
    ...
    async def get(self, key: str) -> Any:
        ...
        Raises:
            StorageError: If there is an error getting the data
        """
        pass
    ...
    async def set(self, key: str, value: Any) -> None:
        ...
        Raises:
            StorageError: If there is an error setting the data
        """
        pass
    ...
    async def delete(self, key: str) -> None:
        ...
        Raises:
            StorageError: If there is an error deleting the data
        """
        pass
    ...
    async def exists(self, key: str) -> bool:
        ...
        Raises:
            StorageError: If there is an error checking if the key exists
        """
        pass
    ...
    async def keys(self, pattern: Optional[str] = None) -> List[str]:
        ...
        Raises:
            StorageError: If there is an error getting the keys
        """
        pass
    ...
    async def clear(self) -> None:
        ...
        Raises:
            StorageError: If there is an error clearing the storage
        """
        pass
...
class MemoryStorageProvider(StorageProvider):
    ...
    async def get(self, key: str) -> Any:
        ...
        if key not in self._data:
            raise StorageError(f"Key '{key}' not found")
...
class StorageProviderRegistry:
    ...
    def register(self, provider: StorageProvider) -> None:
        ...
        Raises:
            StorageError: If a storage provider with the same name is already registered
        """
        if provider.name in self._providers:
            raise StorageError(f"Provider '{provider.name}' is already registered")
    ...
    def unregister(self, name: str) -> None:
        ...
        Raises:
            StorageError: If the storage provider is not registered
        """
        if name not in self._providers:
            raise StorageError(f"Provider '{name}' is not registered")
...
def register_memory_provider(name: str) -> None:
    """Register a memory storage provider in the default registry.
...
def register_file_provider(name: str, file_path: str) -> None:
    """Register a file storage provider in the default registry.
...
async def get(name: str, key: str) -> Any:
    ...
    Raises:
        StorageError: If the storage provider is not registered or there is an error getting the data
        ConnectionError: If the storage provider is not connected
    """
    provider = get_provider(name)
...
async def set(name: str, key: str, value: Any) -> None:
    ...
    Raises:
        StorageError: If the storage provider is not registered or there is an error setting the data
        ConnectionError: If the storage provider is not connected
    """
    provider = get_provider(name)
...
async def delete(name: str, key: str) -> None:
    ...
    Raises:
        StorageError: If the storage provider is not registered or there is an error deleting the data
        ConnectionError: If the storage provider is not connected
    """
    provider = get_provider(name)
...
async def exists(name: str, key: str) -> bool:
    ...
    Raises:
        StorageError: If the storage provider is not registered or there is an error checking if the key exists
        ConnectionError: If the storage provider is not connected
    """
    provider = get_provider(name)
...
async def keys(name: str, pattern: Optional[str] = None) -> List[str]:
    ...
    Raises:
        StorageError: If the storage provider is not registered or there is an error getting the keys
        ConnectionError: If the storage provider is not connected
    """
    provider = get_provider(name)
...
async def clear(name: str) -> None:
    ...
    Raises:
        StorageError: If the storage provider is not registered or there is an error clearing the storage
        ConnectionError: If the storage provider is not connected
    """
    provider = get_provider(name)
