"""VectorDB provider implementation for RAG capabilities.

This module provides a VectorDB-based implementation of the RAG provider interface,
using VectorDB2 for lightweight vector storage and retrieval with focus on low latency.
...
@lazy_provider_class("rag", "vectordb")
class VectorDBProvider(BaseProvider):
    """VectorDB implementation of the RAG provider interface.

    This provider supports:
    - Low latency vector operations
    - Simple interface for text storage and retrieval
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.path = path or "vectordb_data"
    ...
    async def initialize(self) -> None:
        ...
        This method sets up the VectorDB database and collection.
        """
        # Import vectordb2 only when provider is instantiated
        vectordb = import_provider("vectordb2", "rag", "vectordb")

        # Initialize database
        os.makedirs(self.path, exist_ok=True)
        self.db = vectordb.Database(self.path)
    ...
    async def add_documents(
        ...
        **kwargs: Any,
        ...
        # Convert documents to VectorDB format
