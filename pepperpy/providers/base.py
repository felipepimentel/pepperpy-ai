...
class ProviderRegistry(Identifiable):
    ...
    def create(
        ...
        if provider_class is None:
            raise ProviderError(f"Provider type '{provider_type}' is not registered")
        # Use provider_type as name if provider_name is not specified
        effective_name = provider_name if provider_name is not None else provider_type
        return provider_class(name=effective_name, **kwargs)
