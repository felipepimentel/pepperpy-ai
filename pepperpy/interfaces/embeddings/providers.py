...
class ProviderFactory:
    ...
    def create_azure_provider(
        cls, api_key: str, endpoint: str, deployment_name: str, **kwargs
        ...
        return AzureEmbeddingProvider(
            api_key=api_key, endpoint=endpoint, deployment_name=deployment_name
        )

    @classmethod
    def create_cohere_provider(
        cls, api_key: Optional[str] = None, model: str = "embed-english-v2.0", **kwargs
