"""Storage types for Pepperpy."""

from typing import Any, Dict, List, Optional, Protocol, TypeVar, Union, runtime_checkable
from .base import ContextManageable, Disposable
from .data import Storable, Indexable, Cacheable
...
@runtime_checkable
class StorageBackend(ContextManageable, Disposable, Protocol[T]):
    """Protocol for objects that can be used as storage backends."""
